...
public class CassandraInitializer {
    ...
    public void init()
    {
        ...
        Patient p1 = new Patient(UUIDs.timeBased(), "John", "Doe", "1885-09-22", "555 SJSU drive San Jose, CA", "408-555-5555");
        ppi.insertPatient(p1);

        Diagnosis d1 = new Diagnosis(p1.getId(),"6-2","200lbs","Alzheimer","ONGOING");
        pdi.insertDiagnosis(d1);

        Patient p2 = new Patient(UUIDs.timeBased(), "Jack", "Smith", "1893-09-22", "555 SJSU drive San Jose, CA", "408-555-5555");
        ppi.insertPatient(p2);

        Diagnosis d2 = new Diagnosis(p2.getId(),"6-2","200lbs","Cancer","ICU");
        pdi.insertDiagnosis(d2);

        Patient p3 = new Patient(UUIDs.timeBased(), "Tina", "Turner", "1881-09-22", "555 SJSU drive San Jose, CA", "408-555-5555");
        ppi.insertPatient(p3);

        Diagnosis d3 = new Diagnosis(p3.getId(),"6-2","200lbs","Lung Disease","ONGOING");
        pdi.insertDiagnosis(d3);

        Patient p4 = new Patient(UUIDs.timeBased(), "Tom", "Sawyer", "1931-09-22", "555 SJSU drive San Jose, CA", "408-555-5555");
        ppi.insertPatient(p4);

        Diagnosis d4 = new Diagnosis(p4.getId(),"6-2","200lbs","Fractured Tibia","URGENTCARE");
        pdi.insertDiagnosis(d4);

        Patient p5 = new Patient(UUIDs.timeBased(), "Lola", "Jones", "1952-09-22", "555 SJSU drive San Jose, CA", "408-555-5555");
